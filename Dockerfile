...
RUN ["/opt/tools/android-accept-licenses.sh", "android update sdk --force --no-ui --filter platform-tools"]
RUN ["/opt/tools/android-accept-licenses.sh", "android update sdk --force --no-ui --filter tools"]
RUN ["/opt/tools/android-accept-licenses.sh", "android update sdk --all --force --no-ui --filter build-tools-23.0.3,android-23,addon-google_apis-google-23,extra-android-m2repository,extra-google-m2repository,extra-google-google_play_services,extra-google-market_licensing,extra-google-play_billing,extra-google-market_apk_expansion,extra-google-gcm"]
